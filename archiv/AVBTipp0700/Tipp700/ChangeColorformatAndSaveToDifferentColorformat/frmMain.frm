...
Private Sub cmdLoadPicture_Click()
    ...
    ' Bild laden
    Set picOrg.Picture = LoadPicture(CommonDialog1.FileName)
    
    ' Bild konvertieren
    Set picConv.Picture = ConvertBitmapAllRes(picOrg.Picture, LastPixelFormat)
